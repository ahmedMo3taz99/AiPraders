...
import { Eye, EyeOff, Mail, Lock, User, Phone, Loader2, Zap, Shield, TrendingUp, Users } from 'lucide-react';
    ...
    >
      ...
      <motion.div variants={itemVariants} className="text-center mb-8">
        ...
        <motion.p variants={itemVariants} className="text-gray-300 text-sm">
          أنشئ حسابك في منصة التداول الذكية
        </motion.p>
      </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="relative group">
                <div className={`absolute inset-0 bg-gradient-to-r from-emerald-500/20 to-green-500/20 rounded-xl blur opacity-0 group-focus-within:opacity-100 transition-opacity duration-300 ${focusedField === 'name' ? 'opacity-100' : ''}`} />
                <div className="relative flex items-center">
                  <User className={`absolute left-4 w-5 h-5 transition-colors duration-300 ${focusedField === 'name' ? 'text-emerald-400' : 'text-gray-400'}`} />
                  <input
                    id="name"
                    name="name"
                    type="text"
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="relative group">
                <div className={`absolute inset-0 bg-gradient-to-r from-emerald-500/20 to-green-500/20 rounded-xl blur opacity-0 group-focus-within:opacity-100 transition-opacity duration-300 ${focusedField === 'phone' ? 'opacity-100' : ''}`} />
                <div className="relative flex items-center">
                  <Phone className={`absolute left-4 w-5 h-5 transition-colors duration-300 ${focusedField === 'phone' ? 'text-emerald-400' : 'text-gray-400'}`} />
                  <input
                    id="phone"
                    name="phone"
                    type="tel"
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="relative group">
                <div className={`absolute inset-0 bg-gradient-to-r from-emerald-500/20 to-green-500/20 rounded-xl blur opacity-0 group-focus-within:opacity-100 transition-opacity duration-300 ${focusedField === 'password_confirmation' ? 'opacity-100' : ''}`} />
                <div className="relative flex items-center">
                  <Lock className={`absolute left-4 w-5 h-5 transition-colors duration-300 ${focusedField === 'password_confirmation' ? 'text-emerald-400' : 'text-gray-400'}`} />
                  <input
